...
const dict = {
  ...
  invite_members: { en: "Invite members", nl: "Leden uitnodigen" },
  ...
  share_message: {
    ...
    nl: "Word lid van mijn gedeelde boodschappenlijst:",
  },
  invite_share_title: {
    en: "Household grocery list invite",
    nl: "Uitnodiging boodschappenlijst",
  },
  invite_sign_in_title: { en: "Sign in to join", nl: "Log in om lid te worden" },
  invite_sign_in_desc: {
    en: "You need an account to join this household. Sign in or create one to continue.",
    nl: "Je hebt een account nodig om lid te worden van dit huishouden. Log in of maak een account aan om door te gaan.",
  },
  continue_to_sign_in: { en: "Continue to sign in", nl: "Doorgaan naar inloggen" },
  invite_confirm_title: {
    en: "You've been invited to join {name}.",
    nl: "Je bent uitgenodigd om lid te worden van {name}.",
  },
  invite_join_button: { en: "Join household", nl: "Word lid van huishouden" },
  invite_joined_success: {
  ...
  go_to_current_household: { en: "Go to current household", nl: "Ga naar huidig huishouden" },
  invite_invalid_title: { en: "Invite not valid", nl: "Uitnodiging ongeldig" },
  invite_invalid_desc: {
